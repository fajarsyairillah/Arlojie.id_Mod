                ...
                if (dataSnapshot.child("Users").child(phone).exists()) {
                    ...
                    if (usersData.getPhone().equals(phone)) {
                        if (usersData.getPassword().equals(password)) {
                            Toast.makeText(MainActivity.this, "Kamu Sudah Login", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                    ...
                    Toast.makeText(MainActivity.this, "Akun Dengan nomor" + phone + "Tidak Ada", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
